...
function Convert-WslPackageToApplicationState {
    [CmdletBinding()]
    param(
    ...
    try {
        ...
        if ($applications.Count -eq 0) {
            ...
            return ($applications | ConvertTo-Json -Depth 5)
        }
    }
    catch {
...
Export-ModuleMember -Function 'Convert-WslPackageToApplicationState'
