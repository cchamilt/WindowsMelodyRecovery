...
function Backup-WordSettings {
    ...
    try {
        ...
        $backupPath = Initialize-BackupDirectory -Path "Word" -BackupType "Word Settings" -BackupRootPath $MachineBackupPath
        ...
        $errorRecord = $_
        $errorMessage = @(
            "Failed to backup Word Settings"
...
if ($MyInvocation.InvocationName -ne '.') {
    ...
    Backup-WordSettings -MachineBackupPath $MachineBackupPath -SharedBackupPath $SharedBackupPath
} 