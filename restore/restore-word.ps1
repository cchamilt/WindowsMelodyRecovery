...
function Restore-WordSettings {
    ...
    try {
        ...
        $backupPath = Test-BackupPath -Path "Word" -BackupType "Word Settings"
        ...
        Write-Host "Failed to restore Word Settings: $_" -ForegroundColor Red
        return $false
    }
}
...
if ($MyInvocation.InvocationName -ne '.') {
    ...
    Restore-WordSettings -BackupRootPath $BackupRootPath
} 